<form action="{{ route('parametrizar.update', $model->id) }}" method="POST" class="formentrada" id="add-register">
    @csrf
        ...
        <div class="row">
            <div class="col-12">
                <div class="form-group">
                    ...
                    <input type="text" name="nombre" value="{{ $model->nombre }}" class="form-control" autocomplete="off" required>
                </div>
            </div>
            <div class="col-sm-6 col-12">
                <div class="form-group">
                    <strong>Abreviatura</strong>
                    <input type="text" name="abreviatura" value="{{ $model->nombre_corto }}" class="form-control" autocomplete="off">
                </div>
            </div>
        </div>
    </div>
